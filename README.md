...
- **AI Advisor** (`/advisor`): a ChainGPT-powered chat assistant for questions about RWA tokenization, confidential DeFi, and contract architecture — server-side API key, no key exposure to browser.
